				...
				<div className="bg-black h-screen">
					...
					<form onSubmit={handleSubmit}>
						<div className="flex flex-col p-2">
							...
							/>
							{cardHoldeError && (
								<div className="error text-white">{cardHoldeError}</div>
							)}
						</div>
						<div className="flex flex-col p-2">
							<label
							...
							/>
							{cardNumberError && (
								<div className="error text-white">{cardNumberError}</div>
							)}
						</div>
						<div>
							{" "}
							<span id="cardType" className="text-white">
								{cardType}
							</span>
						</div>
						<div className="flex flex-row">
							<div className="flex flex-col p-2">
								...
								/>
								{expiryError && (
									<div className="error text-white">{expiryError}</div>
								)}
							</div>
